<?php
	...
	/* ========================================================================================================
		...
		- fields: array
			...
			- lookup: array	(required only if type=T_LOOKUP)
				...
				- dropdown_sort: string|array (optional) (default: asc)
					...
					If an array is provided, it needs to map fields to sort order, e.g.
						'dropdown_sort' => ['nr' => 'asc', 'label' => 'asc']
					Note: for CARDINALITY_MULTIPLE lookups, this may lead to unexpected behavior when a linked record is removed from list of linked records. The JS code that does the insertion is not aware of any database fields that are not displayed in the option's label. 
			...
			- view_hide: boolean (optional) (default: false)
				Determines whether this field is hidden from the record display in MODE_VIEW
			...
			- display_value_postproc: string (optional)
				Name of a function to call when displaying the value of a field in MODE_VIEW or MODE_LIST. The function must return the value to display.
				The function will receive the following arguments:
					* $html_value (string): HTML string that was generated by dbWebGen (i.e. the default value display behaviour)
